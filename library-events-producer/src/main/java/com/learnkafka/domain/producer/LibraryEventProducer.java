package com.learnkafka.domain.producer;
...
public class LibraryEventProducer {
    ...
    private void handleFailure(Integer key, String value, Throwable ex) {
        log.error("Error sending the mssage and the exception is : {}", ex.getMessage());
        try {
            throw ex;
        } catch (Throwable throwable) {
            log.error("Erro in OnFailure: {}", throwable.getMessage());
        }
    }
    ...
    public SendResult<Integer, String> sendLibraryEventSynchronous(LibraryEvent libraryEvent) throws JsonProcessingException, ExecutionException, InterruptedException {
        ...
        try {
            ...
            log.error("InterruptedException sending the mssage and the exception is : {}", e.getMessage());
            throw e;
        }catch (Exception e) {
            log.error("Exception sending the mssage and the exception is : {}", e.getMessage());
            throw e;
        }
        return sendResult;
    }
